...
function anim_PressureControl(lowerSpanLevel,higherSpanLevel){	
	...
	var PL_tank = PL_Tank1 (x, y);
    PTCircle1 = PC_PTCircleWithLabel1((x+150),(y-70), 25, "PT 100");	
	var PY1001 = PC_CircleWithLabel1((x-290),(y-60), 25, "PY 100");
	var PIC1001_Circle = PC_CircleWithLine1((x+150),(y-170), 25, "PIC", "100"); 	 
	 ...
	 var MV100 = Label3((x+410), (y+120), "PCV 200");
	 var UD = Label3((x+470), (y+25), "User Demand");
	 var outlet = Label3((x+494), (y+93), "Gas Out");
	 var inlet = Label3((x-370), (y+65), "Gas In");
	 var T100 = Label3((x+150), (y+60), "P 100");
