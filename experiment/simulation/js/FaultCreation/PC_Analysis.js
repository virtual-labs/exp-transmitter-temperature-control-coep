...
//		  {
			  TransmitterDB +=' <div class="successMsg">Congratulations!!! Pressure control system (Transmitter) experiment is completed successfully!! <br/><span id="AnalysisStatus"></span></div>'
